...
class Laporan_leger extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('akademik_laporan_km/laporan_leger/laporan_leger_css');
            $this->load->view('layout/header-bottom', $data);
            $this->load->view('layout/main-navigation', $data);
            $this->load->view('akademik_laporan_km/laporan_leger/laporan_leger_v', $data);
            $this->load->view('layout/footer-top');
            $this->load->view('akademik_laporan_km/laporan_leger/laporan_leger_js');
