...
class Tahun_aktif extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $data['gugus'] = $this->db->get_where('m_gugus')->row_array();
            $data['sekolah'] = $this->db->get_where('m_sekolah',['kd_sekolah' => $this->session->userdata('kd_sekolah')])->row_array();
           
            $data['data_sekolah'] = $this->tahun_aktif->get_datasekolah();
    ...
    public function tambah()
    {
        ...
        $data['p_guru']  = $this->db->get_where('m_guru',['kd_sekolah' => $this->session->userdata('kd_sekolah')])->result_array();
