                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted"> <?= $sekolah['kd_sekolah'] ?></p>
                            <hr>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="profil">
                                    ...
                                    <input type="hidden" name="kd_sekolah" value="<?= $sekolah['kd_sekolah'] ?>">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="kd_sekolah" name="kd_sekolah" value="<?= $sekolah['kd_sekolah'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group row">
