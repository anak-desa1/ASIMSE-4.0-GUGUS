...
class Atur_walikelas extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->form_validation->run() == false) {
            ...
            $data['data_sekolah'] = $this->atur_walikelas->get_datasekolah();
    ...
    public function tambah()
    {
        ...
        $data['guru'] = $this->db->get_where('pegawai_data',['kd_sekolah' => $this->session->userdata('kd_sekolah')])->result_array();
