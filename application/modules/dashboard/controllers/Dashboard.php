...
class Dashboard extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['gugus'] = $this->dashboard->gugus();
        ...
        $data['to_sekolah'] = $this->dashboard->TotalSekolah();    
        $data['online'] = $this->dashboard->TotalOnline();

        $data['guru_s'] = $this->dashboard->TotalGuruSekolah();
        $data['siswa_s'] = $this->dashboard->TotalSiswaSekolah();       
        $data['online_s'] = $this->dashboard->TotalOnlineSekolah();
