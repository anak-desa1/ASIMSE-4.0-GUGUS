                            ...
                            <tbody>
                                ...
                                <?php foreach ($tahun->result() as $r) : ?>
                                    <tr>
                                        ...
                                        <td><?= $r->tahun; ?></td>
                                        <td>
                                            <a class="btn btn-warning" href="" data-tahun="<?= $r->tahun; ?>" data-id="<?= $r->id; ?>" data-bs-toggle="modal" data-bs-target="#editModal" title="Edit"><i class="bi bi-pencil-square"></i></a>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('data_persiapan/persiapan_tahun/edittahun'); ?>" method="post">
                <div class=" modal-body">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" id="ed_tahun" name="ed_tahun" placeholder="tingkat">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
