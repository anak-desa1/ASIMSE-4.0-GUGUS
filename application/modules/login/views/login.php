                    ...
                    <div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="login-box" style="margin-top: 40px;">
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="pt-4 pb-3">
                                        <center><img class="img-responsive img" alt="Responsive image" src="<?= base_url() ?>panel/dist/upload/logo/<?= $gugus['logo'] ?>" width="90px"></center>
                        ...
                        <p class="text-center" style="background-color: #3c8dbc; color: #FFFFFF; border-bottom-right-radius: 20px; box-shadow: 0px 1px 6px 0px #3c8dbc;">
                            <?= $title ?> - <?= $gugus['nama_gugus'] ?><br> ASIMSE 4.0 <i class="fa fa-copyright"></i> Copyright <?php echo date("Y");?><br>
